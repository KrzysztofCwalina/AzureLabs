...
namespace Azure.Data
{
    static class SchemaParser
    {
        public static ModelSchema ParseFile(string filename)
        {
            ...
            ModelSchema schema = SchemaParser.ParseJson(schemaJson);
            return schema;
        }
        ...
        public static ModelSchema ParseJson(string schemaJson)
        {
            ...
            foreach (var property in properties.EnumerateObject())
            {
                ...
                var isReadOnly = requiredProperties.Contains(name);
                schema.Add(name, new ModelSchema.PropertySchema(clrType, name, isReadOnly));
            }
